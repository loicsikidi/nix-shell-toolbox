...
> [!TIP]
> `builtins.fetchTarball` caches tarballs in `$HOME/nix/tarball-cache/`.
> If your local nix-shell doesn't detect remote changes, force refresh with: `rm -rf $HOME/nix/tarball-cache/`
